...
//go:embed assets/index.html assets/table.html assets/_settings_panel.html assets/styles.css assets/cards/*.svg assets/js assets/icon.svg assets/favicon.ico assets/apple-touch-icon.png
